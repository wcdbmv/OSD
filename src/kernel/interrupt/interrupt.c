...
void interrupt_init(void)
{
	...
	idt[INTERRUPT_VECTOR_INVALID_OPCODE] = INTERRUPT_GATE(GD_KT, interrupt_handler_invalid_opcode, 0, IDT_DPL_S);
	...
	// only one tss. If you want to use more processors -- you should
